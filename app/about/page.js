		...
		<div className='about-wrapper'>
			...
			<main className={'about'}>
				<article>
					...
					<p>
						Su condición de viajero impenitente le posiciona para enhebrar las historias en las diferentes trayectorias, los relatos se van solapando uno a uno. Su objetivo logra transmitir con nitidez las relaciones de los edificios con sus contextos, los rincones detallados en un tiempo
						determinado.
					</p>

					<p>
						La fotografía a menudo está ligada a la arquitectura desde un punto de vista documental, en el caso de Gabriel el resultado es descriptivo y también narrativo, su lenguaje visual nos hace sumergirnos en las experiencias de su percepción. Desde su lado más personal, siempre logra una
						visión conceptual integrada en el ambiente retratado.
					</p>
					<small className='about-author'>Marisa Santamaría</small>
					<Image src={smimg50} alt='Gabriel Asdrubal taking a shot at Chicago skyline at night' width={600} height={400} />
				</article>
			</main>
		</div>
	);
